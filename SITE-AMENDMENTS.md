# Site Amendment Guide — hillarynjuguna.vercel.app
...
**Live site**: https://hillarynjuguna.vercel.app  
...
# 5. Verify at https://hillarynjuguna.vercel.app
```
...
Search and replace all instances of `hillarynjuguna.vercel.app` with the new domain. Affects:
- `<link rel="canonical">`
...
7. Verify: visit `https://hillarynjuguna.vercel.app/.netlify/functions/chat` → should return `{"error":"Method not allowed"}`
...
```
□ Site loads: https://hillarynjuguna.vercel.app
□ AI functions live: https://hillarynjuguna.vercel.app/.netlify/functions/chat
...
□ Footer shows: Hillary Njuguna · hillarynjuguna.vercel.app
